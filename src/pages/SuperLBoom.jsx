...
import concretePump from '../assets/SuperLongBoomPump.png'; 
...
import OverviewSectionSuperLBoom from '../components/OverviewSectionSuperLBoom';
        ...
        <div className="portfolio-page">
            ...
            <div className="profile-container d-flex">
                ...
                <div className="content-section" ref={textRef}>
                    ...
                    <h1 className="monster-name">SUPER LONG BOOM 36 M</h1>
            ...
            <br />
            <br />
            <div className="baru2"><OverviewSectionSuperLBoom /></div>
            </div>
